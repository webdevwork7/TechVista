  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: 'Smart Home Installation', href: '/services/smart-home' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Professional tech support at your doorstep. Our certified technicians provide fast and reliable service for all your tech needs.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {currentYear} TechAssist. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex space-x-6">
              ...
              <Link to="/sitemap" className="text-gray-500 hover:text-gray-900 text-sm">
                Sitemap
              </Link>
            </div>
          </div>
